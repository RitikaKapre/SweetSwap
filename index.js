...
const conn = mysql.createConnection({
  ...
  database: 'ecbackend' /* MySQL Database */
});
...
app.post('/auth', function(req, res) {
	...
	if (username && password) {
        ...
        // console.log(req.session.usrtyp);
...
let data={prod_name:req.body.name, description:req.body.des,price:req.body.price,saleprice:req.body.saleprice,imagepath:'not config'}
  console.log(data);
